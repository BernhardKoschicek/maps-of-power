...
images = [
        ...
        'category': ['rhr']},
    {
        'src': 'rhr_01.jpg',
        'description': _(
            'Reception of the Serbian King Petar I in Skopje in 1912,'
        ...
        'category': ['rhr']},
    {
        'src': 'rhr_02.jpg',
        'description': _(
            'The Greek and Serbian pavilions at the World Exhibition'
            ' in Paris in 1900'),
        'citation': '',
        'category': ['rhr']}, ]
...
project_rhr = {
    ...
    'cooperation': [],
    'employees': ['Veronika Polloczek (Wien)', 'Lucia Maria Orlandi (Paris)'],
    'begin': get_dates_formatted(2026, 1, 1),
    'end': get_dates_formatted(2027, 12, 31),
    'description': [_('rhr_description_1'),
                    _('rhr_description_2')],
    'results': '',
    'icon': 'rhr_01.jpg',
    'images': images,
