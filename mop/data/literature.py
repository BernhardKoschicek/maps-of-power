...
literatures = [{
    ...
    'author': 'Mihailo St. Popović',
    'title': '„Friedensarbeit inmitten tollsten Krieges“ – Hochschulkurse, '
    ...
    'author': 'Katrin Haase',
    'title': 'Jenseits von Ost und West: Auf den Spuren der „Heiligen '
    ...
    'title': 'Jenseits von Ost und West, in: Forschungsmagazin der HTWK '
    'Leipzig Einblicke 2023',
    'locations': [_('Leipzig')],
    'date': '2023',
    'pages': '5',
    'external_link': 'https://www.htwk-leipzig.de/forschen/'
    ...
    'title': 'Beyond East and West – Geocommunicating Historical Sacred '
    'Landscapes, in: Proc. Int. Cartogr. Assoc., 4, 14, 2021. '
    ...
    'title': 'Historische Ökologie – ein interdisziplinärer Forschungsansatz, '
    'illustriert am Beispiel der Waldstreunutzung. GAIA: Ecological '
    'Perspectives for Science and Society 17/4',
    'locations': '',
    'date': '2008',
    'pages': '370-377',
    ...
    'title': 'Sacred Landscapes, in: Interpreting Late Antiquity. Essays on '
    ...
    'category': ['further']}, {
        ...
        'category': ['further']}, {
            ...
            'Makedonien (Peleus, Studien zur Archäologie und Geschichte '
            'Griechenlands und Zyperns 61)',
            ...
            'der Historischen Geographie des byzantinischen Raumes, in: '
            'Raum und Geschichte: der historische Atlas „Tabula Imperii '
            'Byzantini“ an der Österreichischen Akademie der '
            'Wissenschaften (Studies in Historical Geography and '
            'Cultural Heritage 3).',
            ...
            'the Historical Geography of Byzantium, in: 24th '
            'International Congress of Byzantine Studies, Volume 1. '
            ...
            '24th International Congress of Byzantine Studies, Volume 1. '
            'Proceedings of the Plenary Sessions',
            'locations': [_('venice')],
            'date': '2022',
            'pages': '121-140',
